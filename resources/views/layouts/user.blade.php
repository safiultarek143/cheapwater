...
<head>
    ...
    <title>Cheap-Water| User Dashboard</title>
        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item has-treeview menu-open">
                        <a href="{{ route('user.userOrders')}}" class="nav-link active">
                            <i class="nav-icon fas fa-tachometer-alt"></i>
                            <p>
                                Orders
                                <i class="right fas fa"></i>
                    ...
                    <li class="nav-item has-treeview menu-open">
                        <a href="{{ route('user.address')}}" class="nav-link active">
                            <i class="nav-icon fas fa-tachometer-alt"></i>
                            <p>
                                Shipping Address
                                <i class="right fas fa"></i>
                    ...
                    <li class="nav-item has-treeview menu-open">
                        <a href="{{ route('user.userAccount', Session::get('customer')['customer_id'])}}" class="nav-link active">
                            <i class="nav-icon fas fa-tachometer-alt"></i>
                            <p>
                                Account Information
                                <i class="right fas fa"></i>
