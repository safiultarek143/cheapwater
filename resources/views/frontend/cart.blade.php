                        ...
                        <div class="row">
                            <form action="{{ route('cart.update') }}" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <button class="btn btn-secondary btn-sm" style="margin-right: 25px;">Update<i class="fa fa-edit"></i></button>
                                </div>
                            </form>
                            <form action="{{ route('cart.remove') }}" method="POST">
                                {{ csrf_field() }}
                                <input type="hidden" value="{{ $item->id }}" id="id" name="id">
                                <button class="btn btn-dark btn-sm" style="margin-right: 10px;">Delete<i class="fa fa-trash"></i></button>
                            </form>
                        </div>
                    </div>
                </div>
